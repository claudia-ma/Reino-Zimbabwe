<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.camadas.store') }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="padre" value="{{ old('padre') }}"
                               class="mt-1 w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Madre</label>
                        <input type="text" name="madre" value="{{ old('madre') }}"
                               class="mt-1 w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900">
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="activa" value="1" {{ old('activa') ? 'checked' : '' }}
